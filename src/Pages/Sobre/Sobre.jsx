...
import loja from "../../assets/loja2.jpg";
...
const Sobre = () => {
   return (
      <div id={styles.ct}>
         ...
         <br />
         <p>
            A Capa Cardoso Deluxe, nosso primeiro e único modelo, está movimentando o mercado em direção a modelos de qualidade e acessíveis,
            ...
            em vendas. Atualmente, a Capas Cardoso Deluxe já é uma capa mais bem avaliado do Brasil e conta com uma média de satisfação 5,0, a
            melhor média entre todas as empresas do nosso mercado.
         </p>
         <br />
         <p>
